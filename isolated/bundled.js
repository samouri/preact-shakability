(() => {
  ...
  function w(n2, l2, u2, i2, t2, r2, o2, f2, s2, a2) {
    var h2, v, p, _2, b2, m2, g2, w2 = i2 && i2.__k || c, A = w2.length;
    for (u2.__k = [], h2 = 0; h2 < l2.length; h2++)
      if ((_2 = u2.__k[h2] = (_2 = l2[h2]) == null || typeof _2 == "boolean" ? null : typeof _2 == "string" || typeof _2 == "number" || typeof _2 == "bigint" ? y(null, _2, null, null, _2) : Array.isArray(_2) ? y(d, { children: _2 }, null, null, null) : _2.__b > 0 ? y(_2.type, _2.props, _2.key, null, _2.__v) : _2) != null) {
        ...
        j(n2, _2, p = p || e, t2, r2, o2, f2, s2, a2), b2 = _2.__e, (v = _2.ref) && p.ref != v && (g2 || (g2 = []), p.ref && g2.push(p.ref, null, _2), g2.push(v, _2.__c || b2, _2)), b2 != null ? (m2 == null && (m2 = b2), typeof _2.type == "function" && _2.__k === p.__k ? _2.__d = s2 = x(_2, s2, n2) : s2 = P(n2, _2, p, w2, b2, s2), typeof u2.type == "function" && (u2.__d = s2)) : s2 && p.__e == s2 && s2.parentNode != n2 && (s2 = k(p));
      }
    ...
    try {
      n:
        if (typeof P2 == "function") {
          ...
          h2.context = x2, h2.props = m2, h2.state = h2.__s, (s2 = l.__r) && s2(u2), h2.__d = false, h2.__v = u2, h2.__P = n2, s2 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s, h2.getChildContext != null && (t2 = a(a({}, t2), h2.getChildContext())), v || h2.getSnapshotBeforeUpdate == null || (k2 = h2.getSnapshotBeforeUpdate(y2, p)), A = s2 != null && s2.type === d && s2.key == null ? s2.props.children : s2, w(n2, Array.isArray(A) ? A : [A], u2, i2, t2, r2, o2, f2, e2, c2), h2.base = u2.__e, u2.__h = null, h2.__h.length && f2.push(h2), b2 && (h2.__E = h2.__ = null), h2.__e = false;
        } else
  ...
  function L(l2, u2, i2, t2, r2, o2, f2, c2) {
    var s2, a2, v, y2 = i2.props, p = u2.props, d2 = u2.type, _2 = 0;
    ...
    if (d2 === null)
      ...
      if (o2 = o2 && n.call(l2.childNodes), a2 = (y2 = i2.props || e).dangerouslySetInnerHTML, v = p.dangerouslySetInnerHTML, !c2) {
        if (o2 != null)
          for (y2 = {}, _2 = 0; _2 < l2.attributes.length; _2++)
            y2[l2.attributes[_2].name] = l2.attributes[_2].value;
        (v || a2) && (v && (a2 && v.__html == a2.__html || v.__html === l2.innerHTML) || (l2.innerHTML = v && v.__html || ""));
      }
      if (C(l2, p, y2, r2, c2), v)
        u2.__k = [];
  ...
  // isolated/forward-ref.js
  var oldDiffHook = l._diff;
  l._diff = (vnode) => {
